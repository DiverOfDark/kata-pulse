...
mod tests {
    ...
    fn test_cpu_conversion() {
        ...
        // Add samples: user=100 jiffies, system=50 jiffies
        ...
        // (100 + 50) / 100 = 1.5 seconds
        assert_eq!(cpu_metrics.usage_seconds_total, 1.5);
        assert_eq!(cpu_metrics.user_seconds_total, 1.0);
        assert_eq!(cpu_metrics.system_seconds_total, 0.5);
    }
